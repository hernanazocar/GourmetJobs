...
export default function Nav() {
  ...
  return (
    ...
    >
      <div
        className="transition-all duration-300 px-6 md:px-10 py-2.5 flex items-center justify-between"
        style={{
          background: scrolled
            ? "rgba(232, 85, 32, 0.98)"
            : "#E85520",
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="text-sm font-bold text-white bg-white/20 hover:bg-white/30 transition px-4 py-2 rounded-lg flex items-center gap-1.5"
          >
            🏢 Demo empresa
          </a>
          <a
