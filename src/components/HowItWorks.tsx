        ...
        <div className="grid md:grid-cols-3 gap-6 mt-14">
          {howItWorks.map((step, index) => (
            <RevealWrapper key={step.number} delay={index * 0.08}>
              <div className="group relative bg-white/90 rounded-[28px] p-8 border border-light-border text-left overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:border-orange/20">
                ...
                <span className="absolute top-4 right-4 text-6xl font-extrabold text-orange/10 group-hover:text-orange/20 transition">
                  {step.number}
                </span>
                ...
                <span className="mt-4 inline-block bg-[#FFF0E6] text-orange text-xs font-semibold px-3 py-1 rounded-full">
                  {step.chip}
                </span>
              </div>
            </RevealWrapper>
