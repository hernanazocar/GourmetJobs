...
export default function FinalCTA() {
  return (
    <section className="sec-light py-24 px-4 md:px-8">
      <div className="relative z-10 max-w-6xl mx-auto rounded-[28px] border border-orange/20 bg-white overflow-hidden py-20 px-6 text-center shadow-xl shadow-orange/10">
